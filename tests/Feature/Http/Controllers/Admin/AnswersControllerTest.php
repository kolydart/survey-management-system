...
class AnswersControllerTest extends TestCase
{
    ...
    public function store_returns_an_ok_response()
    {
        ...
        $response = $this->actingAs($user)->post(route('admin.answers.store'), $answer->toArray());
    ...
    public function update_returns_an_ok_response()
    {
        ...
        $response = $this->actingAs($user)->put(route('admin.answers.update', [$answer]), $answer->toArray());

        $response->assertSessionHasNoErrors();

        $response->assertRedirect(route('admin.answers.show', $answer->id));
