    ...
    data() {
        return {
            columns: [
                ...
                { title: 'Χρήστης', field: 'user', tdComp: DatatableSingle },
                { title: 'Ενέργεια', field: 'action', sortable: true },
                { title: 'Action model', field: 'action_model', sortable: true },
                { title: 'Action id', field: 'action_id', sortable: true },
